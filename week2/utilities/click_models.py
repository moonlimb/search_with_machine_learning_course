...
def step(x):
    """
    Simple heuristic for bucketing grades. Use ratio of clicks to impressions
    assign relevancy based on ratio (low click counts -> non-relevant, high click counts -> relevant) 
    """
    if x < 0.05: return 0
