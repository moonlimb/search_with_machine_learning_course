...
kill -i $(pgrep -f 'logstash')

# echo "Delete indices"
# delete indices in console
...
curl -k -X PUT -u admin  "https://localhost:9200/bbuy_products_retry" -H 'Content-Type: application/json' -d "@$PRODUCTS_JSON_FILE"
